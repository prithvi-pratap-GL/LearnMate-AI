...
def generate_dynamic_questions(topic: str, difficulty: str = "beginner"):
    ...
    beginner_questions = {
        "python": [
            {"q": "What is Python's package manager called?", "correct": "pip", "options": ["conda", "pip", "npm", "brew"]},
            {"q": "Which symbol is used for comments in Python?", "correct": "#", "options": ["//", "/*", "#", "--"]},
            {"q": "What data structure uses key-value pairs?", "correct": "Dictionary", "options": ["List", "Tuple", "Dictionary", "Set"]},
            {"q": "Which is a mutable data type in Python?", "correct": "List", "options": ["Tuple", "String", "List", "Integer"]},
            {"q": "What does PEP 8 define?", "correct": "Style Guide", "options": ["Package Structure", "Style Guide", "Performance Metrics", "Python Engine Protocol"]},
            {"q": "What is a variable in Python?", "correct": "Container for storing values", "options": ["A function", "Container for storing values", "A class", "An error"]},
            {"q": "How do you create a list in Python?", "correct": "Using square brackets []", "options": ["Using curly braces {}", "Using parentheses ()", "Using square brackets []", "Using angle brackets <>"]},
            {"q": "What does the print() function do?", "correct": "Displays output to console", "options": ["Reads user input", "Displays output to console", "Deletes variables", "Imports modules"]},
            {"q": "What is an integer in Python?", "correct": "Whole number", "options": ["Decimal number", "Whole number", "Text string", "Boolean value"]},
            {"q": "How do you define a function in Python?", "correct": "Using def keyword", "options": ["Using function keyword", "Using def keyword", "Using lambda only", "Using class only"]},
        ],
        "javascript": [
            {"q": "What does JavaScript stand for?", "correct": "Standardized programming language", "options": ["Java Script language", "Standardized programming language", "JavaScript Extension", "Just A Script"]},
            {"q": "How do you create a variable in JavaScript?", "correct": "Using var, let, or const", "options": ["Using $ symbol", "Using var, let, or const", "Using # symbol", "Using :: operator"]},
            {"q": "What is an array in JavaScript?", "correct": "Ordered list of values", "options": ["A single value", "Ordered list of values", "A function", "A string"]},
            {"q": "How do you add an element to an array?", "correct": "Using push() method", "options": ["Using add() method", "Using push() method", "Using append() method", "Using insert() method"]},
            {"q": "What is a function in JavaScript?", "correct": "Reusable block of code", "options": ["A variable", "Reusable block of code", "A loop", "An object"]},
            {"q": "How do you write a comment in JavaScript?", "correct": "// for single line or /* */ for multi-line", "options": ["# for comments", "-- for comments", "// for single line or /* */ for multi-line", "' for comments"]},
            {"q": "What is the console.log() function used for?", "correct": "Printing output to console", "options": ["Reading input", "Printing output to console", "Clearing the console", "Deleting variables"]},
            {"q": "What is undefined in JavaScript?", "correct": "Value of a variable that has no value", "options": ["An error type", "Value of a variable that has no value", "A keyword", "A number"]},
            {"q": "How do you check if a value is null?", "correct": "Using === null", "options": ["Using == empty", "Using === null", "Using null check", "Using isEmpty()"]},
            {"q": "What is a string in JavaScript?", "correct": "Sequence of characters", "options": ["A number", "Sequence of characters", "A boolean", "An array"]},
        ],
        "machine learning": [
            {"q": "What does ML stand for?", "correct": "Machine Learning", "options": ["Multi-Layer", "Mobile Learning", "Model Logic", "Machine Learning"]},
            {"q": "What is supervised learning?", "correct": "Learning with labeled data", "options": ["Learning without labels", "Learning with labeled data", "Learning from images", "Learning from text"]},
            {"q": "What is a dataset?", "correct": "Collection of data for training", "options": ["A single data point", "Collection of data for training", "A machine", "A model"]},
            {"q": "What is a feature in ML?", "correct": "Input variable used for prediction", "options": ["Output result", "Input variable used for prediction", "A model", "An error"]},
            {"q": "What is training in ML?", "correct": "Process of teaching a model with data", "options": ["Testing a model", "Process of teaching a model with data", "Deploying a model", "Evaluating accuracy"]},
            {"q": "What is NumPy used for?", "correct": "Numerical computations", "options": ["Web development", "Numerical computations", "Game creation", "Database management"]},
            {"q": "What is Pandas used for?", "correct": "Data manipulation and analysis", "options": ["Web frameworks", "Data manipulation and analysis", "Image processing", "Text generation"]},
            {"q": "What is a classifier?", "correct": "Algorithm that predicts categories", "options": ["Tool for organizing files", "Algorithm that predicts categories", "Data processor", "Error handler"]},
            {"q": "What is accuracy in ML?", "correct": "Percentage of correct predictions", "options": ["Speed of prediction", "Percentage of correct predictions", "Model size", "Training time"]},
            {"q": "What is a neural network?", "correct": "Network of connected nodes inspired by brain", "options": ["Computer network", "Network of connected nodes inspired by brain", "A type of database", "A web server"]},
        ],
        "data science": [
            {"q": "What is data science?", "correct": "Field that extracts insights from data", "options": ["Science of computers", "Field that extracts insights from data", "Data storage", "Database design"]},
            ...
            {"q": "What is data cleaning?", "correct": "Removing errors and inconsistencies", "options": ["Deleting all data", "Removing errors and inconsistencies", "Encrypting data", "Compressing data"]},
            {"q": "What is visualization in data science?", "correct": "Creating charts and graphs", "options": ["Writing code", "Creating charts and graphs", "Reading files", "Training models"]},
            {"q": "What is a CSV file?", "correct": "Comma-separated values file", "options": ["Computer Specific Values", "Comma-separated values file", "Central Storage Vault", "Code Syntax Validator"]},
            {"q": "What is correlation?", "correct": "Relationship between two variables", "options": ["A type of database", "Relationship between two variables", "An error type", "A programming language"]},
            {"q": "What is a null value?", "correct": "Missing or undefined data", "options": ["Zero value", "Missing or undefined data", "Empty string", "False boolean"]},
            {"q": "What is normalization?", "correct": "Scaling data to standard range", "options": ["Organizing files", "Scaling data to standard range", "Removing duplicates", "Adding new data"]},
            {"q": "What is a dashboard?", "correct": "Visual display of key metrics", "options": ["Car control panel", "Visual display of key metrics", "Programming tool", "Data file"]},
        ],
    }
    ...
    advanced_questions = {
        "python": [
            {"q": "What is the Global Interpreter Lock (GIL)?", "correct": "Threading mechanism that limits parallel execution", "options": ["Global variable handler", "Threading mechanism that limits parallel execution", "Memory manager", "Garbage collector"]},
            {"q": "What are metaclasses in Python?", "correct": "Classes that define how classes behave", "options": ["Abstract base classes", "Classes that define how classes behave", "Parent classes", "Type annotations"]},
            {"q": "What is the difference between shallow and deep copy?", "correct": "Shallow copies references, deep copies values", "options": ["Speed difference", "Shallow copies references, deep copies values", "Both are identical", "Related to memory allocation"]},
            {"q": "What does asyncio provide?", "correct": "Asynchronous programming support", "options": ["System I/O operations", "Asynchronous programming support", "File management", "Threading utilities"]},
            {"q": "What are context managers used for?", "correct": "Resource acquisition and release", "options": ["Variable scope management", "Resource acquisition and release", "Class management", "Module imports"]},
            {"q": "What is a decorator in Python?", "correct": "Function that modifies another function", "options": ["CSS styling", "Function that modifies another function", "Data structure", "Module import"]},
            {"q": "What does *args do?", "correct": "Accepts variable-length positional arguments", "options": ["Multiplies arguments", "Accepts variable-length positional arguments", "Creates array", "Pointer reference"]},
            {"q": "What does **kwargs do?", "correct": "Accepts variable-length keyword arguments", "options": ["Power operator", "Accepts variable-length keyword arguments", "XOR operation", "Multiplication"]},
            {"q": "What is a generator in Python?", "correct": "Function that yields values lazily", "options": ["Random number creator", "Function that yields values lazily", "Data generator tool", "Code generator"]},
            {"q": "What is the with statement used for?", "correct": "Context management for resource handling", "options": ["Conditional logic", "Context management for resource handling", "Loop iteration", "Function definition"]},
        ],
        "javascript": [
            {"q": "What is the event loop in JavaScript?", "correct": "Mechanism for executing asynchronous code", "options": ["Error handling", "Mechanism for executing asynchronous code", "DOM manipulation", "Module loading"]},
            {"q": "What are closures in JavaScript?", "correct": "Functions with access to outer scope variables", "options": ["Loop termination", "Functions with access to outer scope variables", "Error handling", "Data structures"]},
            {"q": "What is hoisting in JavaScript?", "correct": "Moving declarations to the top of scope", "options": ["Lifting objects", "Moving declarations to the top of scope", "Error throwing", "Variable assignment"]},
            {"q": "What is the difference between Promise and async/await?", "correct": "async/await is cleaner syntax for Promises", "options": ["Same thing", "async/await is cleaner syntax for Promises", "Promises are faster", "No difference"]},
            {"q": "What are prototypes in JavaScript?", "correct": "Objects from which other objects inherit", "options": ["Test versions", "Objects from which other objects inherit", "Design patterns", "API endpoints"]},
            {"q": "What is the this keyword binding?", "correct": "Refers to object context of execution", "options": ["Creates variables", "Refers to object context of execution", "Loops through data", "Deletes properties"]},
            {"q": "What are higher-order functions?", "correct": "Functions that take or return functions", "options": ["Functions with many parameters", "Functions that take or return functions", "Complex calculations", "Recursive functions"]},
            {"q": "What is destructuring in JavaScript?", "correct": "Unpacking values from objects or arrays", "options": ["Deleting data", "Unpacking values from objects or arrays", "Modifying structure", "Rebuilding objects"]},
            {"q": "What is the spread operator used for?", "correct": "Expanding iterables into individual elements", "options": ["Mathematical division", "Expanding iterables into individual elements", "String operations", "Object creation"]},
            {"q": "What is currying in JavaScript?", "correct": "Converting function with multiple args into sequence of single-arg functions", "options": ["Adding functions", "Converting function with multiple args into sequence of single-arg functions", "Error handling", "Data transformation"]},
        ],
        "machine learning": [
            {"q": "What is the curse of dimensionality?", "correct": "Performance degradation with too many features", "options": ["Memory issues only", "Performance degradation with too many features", "Training time", "Model complexity"]},
            {"q": "What is ensemble learning?", "correct": "Combining multiple models for better predictions", "options": ["Using single model", "Combining multiple models for better predictions", "Sequential training", "Parallel processing"]},
            {"q": "What is the difference between L1 and L2 regularization?", "correct": "L1 uses absolute values, L2 uses squared values", "options": ["Speed difference", "L1 uses absolute values, L2 uses squared values", "L1 for classification", "Same regularization"]},
            {"q": "What is batch normalization?", "correct": "Normalizing layer inputs to stabilize training", "options": ["Data cleaning", "Normalizing layer inputs to stabilize training", "Model compression", "Batch processing"]},
            {"q": "What is the vanishing gradient problem?", "correct": "Gradients becoming too small to update weights", "options": ["Data disappearing", "Gradients becoming too small to update weights", "Model convergence", "Overfitting"]},
            {"q": "What is transfer learning?", "correct": "Using pre-trained models as starting point", "options": ["Moving models between systems", "Using pre-trained models as starting point", "Transferring data", "Model cloning"]},
            {"q": "What is dropout in neural networks?", "correct": "Randomly disabling neurons to prevent overfitting", "options": ["Removing layers", "Randomly disabling neurons to prevent overfitting", "Data dropping", "Model pruning"]},
            {"q": "What is backpropagation?", "correct": "Algorithm for calculating gradients in neural networks", "options": ["Moving backwards", "Algorithm for calculating gradients in neural networks", "Reversing predictions", "Error correction"]},
            {"q": "What is attention mechanism?", "correct": "Mechanism to focus on relevant input parts", "options": ["Error detection", "Mechanism to focus on relevant input parts", "Monitoring system", "Debug tool"]},
            {"q": "What is hyperparameter tuning?", "correct": "Optimizing model parameters before training", "options": ["Training the model", "Optimizing model parameters before training", "Testing accuracy", "Deployment process"]},
        ],
        "data science": [
            {"q": "What is feature extraction vs feature selection?", "correct": "Extraction creates features, selection chooses existing ones", "options": ["Same concept", "Extraction creates features, selection chooses existing ones", "Selection is always better", "Extraction for images only"]},
            {"q": "What is SHAP values used for?", "correct": "Explaining individual model predictions", "options": ["Performance metrics", "Explaining individual model predictions", "Data validation", "Feature scaling"]},
            {"q": "How do you handle imbalanced datasets?", "correct": "Oversampling, undersampling, or SMOTE", "options": ["Ignore them", "Oversampling, undersampling, or SMOTE", "Use accuracy", "Increase complexity"]},
            {"q": "What is Bayesian optimization?", "correct": "Parameter tuning using probabilistic model", "options": ["Probability calculation", "Parameter tuning using probabilistic model", "Bayesian statistics", "Model validation"]},
            {"q": "What is the bias-variance tradeoff?", "correct": "Balancing model complexity and generalization", "options": ["Input to output ratio", "Balancing model complexity and generalization", "Accuracy vs Precision", "Training vs Testing"]},
            {"q": "What is cross-validation used for?", "correct": "Evaluating model on multiple data splits", "options": ["Data augmentation", "Evaluating model on multiple data splits", "Feature scaling", "Hyperparameter search"]},
            {"q": "What is ARIMA used for?", "correct": "Time series forecasting", "options": ["Image processing", "Time series forecasting", "Text analysis", "Classification"]},
            {"q": "What is the Gini coefficient?", "correct": "Measure of impurity in decision trees", "options": ["Statistical index", "Measure of impurity in decision trees", "Economic metric", "Probability measure"]},
            {"q": "What is multicollinearity?", "correct": "High correlation between features", "options": ["Multiple models", "High correlation between features", "Many rows of data", "Data type mixing"]},
            {"q": "What is residual analysis?", "correct": "Analyzing prediction errors to improve model", "options": ["Removing data", "Analyzing prediction errors to improve model", "Adding features", "Scaling values"]},
        ],
    }
    ...
    if not questions:
        if difficulty.lower() in ["advanced", "hard", "expert"]:
            questions = [
                {"q": f"What are advanced techniques in {topic}?", "correct": "Specialized methods", "options": ["Basic methods", "Specialized methods", "Historical approach", "Deprecated methods"]},
                {"q": f"How do you optimize {topic} for production?", "correct": "Performance tuning", "options": ["Add more data", "Performance tuning", "Increase complexity", "Use defaults"]},
                {"q": f"What are edge cases in {topic}?", "correct": "Boundary conditions", "options": ["Main cases", "Boundary conditions", "Error types", "Test cases"]},
                {"q": f"How do you scale {topic} solutions?", "correct": "Handling growth", "options": ["Reduce data", "Handling growth", "Simplify design", "Use shortcuts"]},
                {"q": f"What is architectural design for {topic}?", "correct": "System design patterns", "options": ["Code structure", "System design patterns", "File organization", "Naming conventions"]},
            ]
        else:
            questions = [
                {"q": f"What is the definition of {topic}?", "correct": "Formal definition", "options": ["A tool", "Formal definition", "A skill", "A concept"]},
                {"q": f"Why is {topic} important?", "correct": "Essential knowledge", "options": ["Rarely used", "Essential knowledge", "Outdated", "Theoretical"]},
                {"q": f"How do you start learning {topic}?", "correct": "Fundamentals first", "options": ["Advanced topics", "Fundamentals first", "Without practice", "Random order"]},
                {"q": f"What tools help with {topic}?", "correct": "Supporting software", "options": ["Pen and paper", "Supporting software", "Nothing needed", "Hardware only"]},
    ...
    if "Generate 5 core concept" in prompt and "MCQ" in prompt:
        ...
        if questions_data:
            ...
            for idx, q in enumerate(questions_data, 1):
                ...
                analysis_sections.append(f"**Question {idx}**: {q.get('question', 'N/A')}")
                analysis_sections.append(f"- Your Answer: {q.get('student_answer', 'No answer')}")
                analysis_sections.append(f"- Correct Answer: {q.get('correct_answer', 'N/A')}")
                analysis_sections.append(f"- Status: {status}")
                analysis_sections.append(f"- Explanation: In {topic}, {correct_ans} is correct because it represents a key concept. Your answer shows understanding of {'the core concept' if is_correct else 'an adjacent area that needs clarification'}.")
                analysis_sections.append("")

        # Add summary
        analysis_sections.append("### Summary of Strengths:")
        if correct_count >= 4:
            analysis_sections.append(f"- Strong grasp of {topic} fundamentals ({correct_count}/5 correct)")
            analysis_sections.append(f"- Demonstrated ability to apply {topic} concepts")
            analysis_sections.append(f"- Ready to progress to more advanced {topic} topics")
        elif correct_count >= 2:
            analysis_sections.append(f"- Reasonable understanding of {topic} basics ({correct_count}/5 correct)")
            ...
            analysis_sections.append(f"- Foundation building phase in {topic} ({correct_count}/5 correct)")
            analysis_sections.append(f"- Important to review {topic} fundamentals")
            analysis_sections.append(f"- Consistent practice with {topic} concepts will help")
        ...
        if questions_data:
            for idx, q in enumerate(questions_data, 1):
                ...
                solution_sections.append(f"**Explanation**: In {topic}, {correct_ans} is the correct choice because:")
                solution_sections.append(f"- It represents a fundamental principle in {topic}")
                solution_sections.append(f"- It is supported by {topic} best practices and standards")
                solution_sections.append(f"- It demonstrates proper understanding of {topic} concepts")
                solution_sections.append(f"- In practical {topic} applications, this approach is preferred\n")

        solution_sections.append("### Key Takeaways")
        solution_sections.append(f"- These answers reflect core {topic} knowledge")
        solution_sections.append(f"- Understanding these concepts is essential for {topic} mastery")
        ...
        if score >= 80:
            challenge_intro = "You've demonstrated strong mastery. Here are expert-level challenges:"
...
4. Integrate {topic} with complementary technologies or patterns"""
        ...
        return [{
            "generated_text": f"""## Advanced Challenge Problems for {topic}
